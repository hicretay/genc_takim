...
UserMatchExistLocationModel userMatchExistLocationModelFromJson(String str) => UserMatchExistLocationModel.fromJson(json.decode(str));

String userMatchExistLocationModelToJson(UserMatchExistLocationModel data) => json.encode(data.toJson());

class UserMatchExistLocationModel {
    UserMatchExistLocationModel({
        this.succes,
        this.result,
    });
    ...
    factory UserMatchExistLocationModel.fromJson(Map<String, dynamic> json) => UserMatchExistLocationModel(
        succes: json["succes"],
